...
class Resque_Failure
{
	 ...
	 * @param \Resque_Worker|null $worker Instance of Resque_Worker that was running this job when it failed.
	 * @param string $queue          The name of the queue that this job was fetched from.
	 */
	public static function create($payload, Exception $exception, $worker, $queue)
	{
